 ...
 *
 */
public class HandCodedPlayer_rasmith9 extends NannonPlayer {

	/** 
	 * You should rename this file to:  HandCodedPlayer_yourLoginName.java
	 * 
	 */
	public HandCodedPlayer_rasmith9() {
	}

	public HandCodedPlayer_rasmith9(NannonGameBoard gameBoard) {
		super(gameBoard);
	}
	@Override
	public String getPlayerName() {
		...
		return "RAS's Hand-Coded Player";
	}
